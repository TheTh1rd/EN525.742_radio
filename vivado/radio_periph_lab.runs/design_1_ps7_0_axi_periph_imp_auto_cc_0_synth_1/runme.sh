...
HD_PWD='C:/EN525.742_radio/vivado/radio_periph_lab.runs/design_1_ps7_0_axi_periph_imp_auto_cc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ps7_0_axi_periph_imp_auto_cc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ps7_0_axi_periph_imp_auto_cc_0.tcl
