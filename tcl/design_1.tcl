...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins full_radio_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
 ...
 connect_bd_net -net axis_broadcaster_0_m_axis_tdata  [get_bd_pins axis_broadcaster_0/m_axis_tdata] \
  [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tdata] \
  [get_bd_pins lowlevel_dac_intfc_0/data_word]
  connect_bd_net -net axis_broadcaster_0_m_axis_tvalid  [get_bd_pins axis_broadcaster_0/m_axis_tvalid] \
